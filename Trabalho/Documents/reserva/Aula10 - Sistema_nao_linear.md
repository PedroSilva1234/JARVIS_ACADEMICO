...
Lilian Berti Resolu¸c˜ao de sistemas n˜ao lineares - M´etodo de Newton
...
Duas esta¸c˜oes el´etricas v˜ao fornecer energia a uma certa regi˜ao da forma mais economˆomica poss´ıvel. O custo total das duas esta¸c˜oes ´e dado por:

f(x1, x2) = 0, 1 + 0, 01x1x2 + 0, 15x4 + 0, 01x4 − 0, 25(x1 + x2 − 100)1

em que x1 ´e a energia fornecida pela primeira esta¸c˜ao e x2 ´e a energia fornecida pela segunda esta¸c˜ao.

Determine os valores de x1 e x2 de forma a minimizar o custo total de opera¸c˜oes das duas esta¸c˜oes. Utilize como aproxima¸c˜ao inicial o ponto [2 ; 0, 5]T e crit´erio de parada erro relativo inferior a  = 0, 2.

Lilian Berti

# Resolu¸c˜ao de sistemas n˜ao lineares - M´etodo de Newton

...
# Estudo do erro na interpola¸c˜ao polinomial
...
Como no caso da s´erie de Taylor, pode ser obtida uma formula¸c˜ao para o erro do trucamento. Na s´erie de Taylor o erro ´e:
...
Lilian Berti  Estudo do erro na interpola¸c˜ao polinomial
...
# Escolha do Grau do Polinˆomio Interpolador

O polinˆomio de grau n aproximar´a bem a fun¸c˜ao se as diferen¸cas divididas de ordem n s˜ao praticamente constantes ou se as diferen¸cas divididas de ordem n + 1 s˜ao pr´oximas de zero.
...
Obter x tal que y = f(x) = 1,3165 usando uma interpola¸c˜ao quadr´atica. Dˆe uma estimativa para o erro.
...
# Fazendo a interpola¸c˜ao quadr´atica com y0 = 1, 2214, y1 = 1, 3499 e y2 = 1, 4918.

...
1. Dada a tabela abaixo, calcule e3,1 usando um polinômio de interpolação na forma de Lagrange sobre três pontos. Dê um limitante para o erro cometido.
...
Com que grau de precisão podemos calcular √115 usando interpolação sobre os pontos x0 = 100, x1 = 121, x2 = 144?

# 8.

A função f(x) = 4senx + e−x admite um valor máximo no intervalo (0, 2). Usando um processo de interpolação quadrática, obtenha uma aproximação para este valor. Tabele a função com espaçamento h = 0, 5 entre os pontos para construir o polinômio.
...
4.
5. (a) 3,7854 m (b) 4,8m
6. Utilizando interpolação inversa para f(x) sobre os pontos: y0 = 0, 67, y1 = 0, 549 e y2 = 0, 449 obtemos: f(0, 5101) ≈ 0, 6 aplicando o processo de interpolação inversa para g(x) sobre os pontos y0 = 0, 32, y1 = 0, 48 e y2 = 0, 56 obtemos g(1.4972) ≈ 0, 5101. Portanto, x ≈ 1, 4972. f(g(1, 4972)) ≈ f(0, 5101) ≈ 0, 6.
7. |E(115)| ≤ 1, 631 × 10−3
8. 4,222
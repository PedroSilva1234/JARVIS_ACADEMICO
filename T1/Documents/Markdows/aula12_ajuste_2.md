...
Lilian Berti Ajuste de Curvas pelo Método dos Quadrados M´ınimos
...
cuja solução é: α1 = −0, 1715 e α2 = −0, 1784.
...
Observação Os parâmetros obtidos não são ótimos dentro do critério de quadrados m´ınimos, pois ajustamos o problema linearizado por quadrados m´ınimos e não o problema original.

# Lilian Berti

# Ajuste de Curvas pelo Método dos Quadrados M´ınimos
...
cuja solução é: α1 = 5, 4846 e α2 = 1, 0713.

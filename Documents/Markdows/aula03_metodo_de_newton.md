...
N˜ao existe um critério de convergência geral para o Método de Newton. Sua convergência depende da natureza da função e da precisão da aproximação inicial. É bom ter uma aproximação inicial “suficientemente” próxima da raiz. E para algumas Funções não funcionária.
...
Suponha que L = 10, r = 1 p´e e V = 12, 4 p´es3. Determine da profundidade da água na gamela com precisão de 0, 01 p´e.

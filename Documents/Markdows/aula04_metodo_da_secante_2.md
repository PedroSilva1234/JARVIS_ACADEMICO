...
xk+1 = xk <frac>- f(xk)</frac>
{f(xk)}

xk+1 = xk <frac>- f(xk)(xk - xk-1)</frac>
{f(xk) - f(xk-1)}
...
As condições de convergência sçao as mesmas do método de Newton, mas a ordem de convergência é superlinear.
